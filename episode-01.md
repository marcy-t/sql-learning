...
# データを入れてみる
``` sql
insert into testtest(id, name, age) values (101, 'Alice', 20);
insert into testtest(id, name, age) values (102, 'Bob', 25);
insert into testtest(id, name, age) values (103, 'Cathy', 22);
```

# まとめて入れる方法
``` sql
insert into testtest(id, name, age) 
values (104, 'Jobs', 56)
     , (105, 'Gates' , 64) 
     , (106, 'Bezos', 56);
```
